...
typedef enum {
  ...
  SBI_RETRIEVE_SM_DATA,
  SBI_REGISTER_WITH_UDM,
  SBI_DEREGISTER_WITH_UDM,
  SBI_DEREGISTER_WITH_UDM_RESPONSE,
  SBI_SUBSCRIBE_SDM_SUBSCRIPTIONS,
  SBI_SUBSCRIBE_SDM_SUBSCRIPTIONS_RESPONSE,
  SBI_UNSUBSCRIBE_SDM_SUBSCRIPTIONS,
  SBI_UNSUBSCRIBE_SDM_SUBSCRIPTIONS_RESPONSE,
  NSMF_PDU_SESSION_CREATE_SM_CTX,
  NSMF_PDU_SESSION_UPDATE_SM_CTX,
  SBI_DISCOVER_UPF,
  SBI_DISCOVER_UPF_RESPONSE,
  UDP_INIT,
  UDP_DATA_REQ,
  UDP_DATA_IND,
  TIME_OUT,
