...
void smf_profile::to_json(nlohmann::json& data) const {
  ...
  for (auto service : nf_services) {
    ...
    srv_tmp["serviceInstanceId"] =
        "5ee667fe-a837-41f0-b10e-11feb67af102";  // TODO: remove hardcoded value
  ...
  for (const auto& service : nf_service_list) {
    nlohmann::json srv_tmp       = {};
    srv_tmp["serviceInstanceId"] = "ecaa6984-a835-41f0-9063-cdd9abebc1e0";
     ...
     */
    srv_tmp["fqdn"] = "oai-smf.openair5g.eur";  // TODO: remove hardcoded value
